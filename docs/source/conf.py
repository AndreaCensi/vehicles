...
try: 
    ...
    version = vehicles.__version__
    # The full version, including alpha/beta/rc tags.
    release = vehicles.__version__
except:
    print('---- Warning: could not get version info; is "vehicles" installed?')
    version = 'unknown'
    release = 'unknown'
...
htmlhelp_basename = 'vehicles_doc'
...
latex_documents = [
  ('index', 'vehicles.tex', u'Vehicles Documentation',
...
man_pages = [
    ('index', 'vehicles', u'Vehicles Documentation',
     [u'Andrea Censi'], 1)
]
